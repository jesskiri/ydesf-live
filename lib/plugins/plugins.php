...
function wsm_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Soliloquy',
			'slug'               => 'soliloquy',
			'source'             => 'https://s3.amazonaws.com/wsm_files/plugins/soliloquy.zip',
			'required'           => false,
			'version'            => '',
			'force_activation'   => false,
			'force_deactivation' => false,
			'external_url'       => 'http://www.web-savvy-marketing.com/go/soliloquy/',
			'is_callable'        => '',
		),

	);

	$theme_text_domain = 'deborah';
	 ...
	 */
	$config = array(
		'id'           => 'wsm',                   // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                      // Default absolute path to bundled plugins.
		'menu'         => 'wsm-install-plugins',   // Menu slug.
