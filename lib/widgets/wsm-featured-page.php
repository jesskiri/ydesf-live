...
class Web_Savvy_Featured_Page extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Displays featured page with thumbnails', 'deborah' ),
		);
		...
		parent::__construct( 'wsmfeatured-page', __( 'WSM - Featured Page', 'deborah' ), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page_id' ); ?>"><?php _e( 'Page', 'deborah' ); ?>:</label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Show Page Title', 'deborah' ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_content' ); ?>"><?php _e( 'Show Page Content', 'deborah' ); ?></label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'content_limit' ); ?>"><?php _e( 'Content Character Limit', 'deborah' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'more_text' ); ?>"><?php _e( 'More Text', 'deborah' ); ?>:</label>
